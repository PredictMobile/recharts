...
function getTicksStart(sign, boundaries, getTickSize, ticks, minTickGap, preserveEnd) {
  ...
  if (preserveEnd) {
    ...
    var tailSize = getTickSize(tail, len - 1, ticks);
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var getTickSize = (content, index, allTicks) => {
    var value = (0, _isFunction.default)(tickFormatter) ? tickFormatter(content.value, index, allTicks) : content.value;
