...
function SetScatterLegend(props) {
  (0, _legendPayloadContext.useLegendPayloadDispatch)(computeLegendPayloadFromScatterProps, props);
  return null;
}
class Scatter extends _react.PureComponent {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    if (hide || !points || !points.length) {
      return /*#__PURE__*/_react.default.createElement(SetScatterLegend, this.props);
    }
    var {
      isAnimationFinished
    } = this.state;
    ...
    }, /*#__PURE__*/_react.default.createElement(SetScatterLegend, this.props), needClipX || needClipY ? /*#__PURE__*/_react.default.createElement("defs", null, /*#__PURE__*/_react.default.createElement("clipPath", {
 ...
 */
_defineProperty(Scatter, "getComposedData", _ref2 => {
  var {
    xAxis,
    yAxis,
    zAxis,
