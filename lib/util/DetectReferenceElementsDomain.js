...
var detectReferenceElementsDomain = (children, domain, axisId, axisType, specifiedTicks) => {
  ...
  if (elements.length) {
    finalDomain = elements.reduce((result, el) => {
      var _el$props;
      var ifOverflow = (_el$props = el.props) === null || _el$props === void 0 ? void 0 : _el$props.ifOverflow;
      if (el.props[idKey] === axisId && ifOverflow === 'extendDomain' && (0, _DataUtils.isNumber)(el.props[valueKey])) {
  ...
  if (areas.length) {
    ...
    finalDomain = areas.reduce((result, el) => {
      var _el$props2;
      var ifOverflow = (_el$props2 = el.props) === null || _el$props2 === void 0 ? void 0 : _el$props2.ifOverflow;
      if (el.props[idKey] === axisId && ifOverflow === 'extendDomain' && (0, _DataUtils.isNumber)(el.props[key1]) && (0, _DataUtils.isNumber)(el.props[key2])) {
